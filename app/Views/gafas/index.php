...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center my-3">
        <h3 id="titulo">GAFAS</h3>
        <div>
            <a href="<?= base_url('gafas/new') ?>" class="btn btn-success">
                <i class="fas fa-glasses"></i> Agregar
            </a>
            ...
            <tbody>
                ...
                <tr class="text-center <?= $gafa['estado'] ? '' : 'table-danger'; ?>">
                    ...
                    <td class="d-flex justify-content-center">
                        ...
                        <button type="button" class="btn btn-danger btn-sm mx-1" data-toggle="modal" data-target="#eliminaModal" data-url="<?= base_url('gafas/' . $gafa['id']); ?>">
                            <i class="fas fa-trash"></i> Eliminar
                        </button>
                        <?php if ($gafa['estado']): ?>
                        <button type="button" class="btn btn-secondary btn-sm mx-1" data-toggle="modal" data-target="#deshabilitarModal" data-url="<?= base_url('gafas/' . $gafa['id'] . '/soft-delete'); ?>">
                            <i class="fas fa-ban"></i> Deshabilitar
                        </button>                                                                                                                                           
                        <?php else: ?>
                        <button type="button" class="btn btn-success btn-sm mx-1" data-toggle="modal" data-target="#habilitarModal" data-url="<?= base_url('gafas/' . $gafa['id'] . '/habilitar'); ?>">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>¿Desea eliminar definitivamente este dispositivo?</p>
            </div>
...
<div class="modal fade" id="deshabilitarModal" tabindex="-1" role="dialog" aria-labelledby="deshabilitarModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>¿Desea deshabilitar esta dispositivo?</p>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="habilitarModal" tabindex="-1" role="dialog" aria-labelledby="habilitarModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>¿Desea habilitar este dispositivo?</p>
            </div>
            <div class="modal-footer">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title" id="verDesactivadosModalLabel">Gafas</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= esc($gafaDeshabilitada['device_id']); ?></td>
                            <td>
                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#habilitarModal" data-url="<?= base_url('gafas/' . $gafaDeshabilitada['id'] . '/habilitar'); ?>">
                                    <i class="fas fa-check"></i> Habilitar
                                </button>
                            </td>
                        </tr>
