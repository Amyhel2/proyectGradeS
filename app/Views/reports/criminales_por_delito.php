...
<head>
    ...
    <title>Reporte de Criminales por Delito</title>
    <style>
        body {
...
<body>
    <div class="reporte-container">
        <h1>REPORTE DE CRIMINALES POR DELITO</h1>
        <table class="tabla-reporte">
            <thead>
                <tr>
                    <th>Tipo de Delito</th>
                    <th>Total Criminales</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($criminales_por_delito as $delito): ?>
                    <tr>
                        <td><?= esc($delito['tipo']); ?></td>
                        <td><?= esc($delito['total']); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
