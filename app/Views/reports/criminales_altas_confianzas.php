...
<head>
    ...
    <title>Reporte de Criminales con Altas Confianzas</title>
    <style>
        body {
...
<body>
    <div class="reporte-container">
        <h1>REPORTE DE CRIMINALES CON ALTAS CONFIANZAS</h1>
        <table class="tabla-reporte">
            ...
            <tbody>
                <?php foreach ($criminales as $criminal): ?>
                    <tr>
                        <td><?= esc($criminal['criminal_id']); ?></td>
                        
                        <td><?= esc($criminal['confianza_media']); ?>%</td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
