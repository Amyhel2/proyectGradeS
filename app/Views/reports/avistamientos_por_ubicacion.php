...
<head>
    ...
    <title>Reporte de Avistamientos por Ubicación</title>
    <style>
        body {
...
<body>
    <div class="reporte-container">
        <h1>REPORTE DE AVISTAMIENTOS POR UBICACIÓN</h1>
        <table class="tabla-reporte">
            ...
            <tbody>
                <?php foreach ($avistamientos as $avistamiento): ?>
                    <tr>
                        <td><?= esc($avistamiento['ubicacion']); ?></td>
                        <td><?= esc($avistamiento['total']); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
