...
<head>
    ...
    <title>Reporte de Criminales Activos e Inactivos</title>
    <style>
        body {
...
<body>
    <div class="reporte-container">
        <h1>REPORTE DE CRIMINALES ACTIVOS E INACTIVOS</h1>
        <table class="tabla-reporte">
            ...
            <tbody>
                <?php foreach ($criminales as $criminal): ?>
                    <tr>
                        <td><?= esc($criminal['activo'] ? 'Activo' : 'Inactivo'); ?></td>
                        <td><?= esc($criminal['total']); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
